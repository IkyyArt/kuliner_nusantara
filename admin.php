...
<html lang="en">
  <head>
    ...
    <link rel="icon" href="img/Logo Kuliner.png" type="image/x-icon">
  ...
  <body>
    ...
    <div class="container">
        <a class="navbar-brand" target="_blank" href=".">Kuliner Nusantara</a>
        <button
    ...
    <footer class="text-center p-3 bg-danger-subtle">
			...
			<div>Rizky Delfa Ramadhani &copy; 2025</div>
    </footer>
    <!-- footer end -->
